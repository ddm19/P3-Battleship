...
public class BoardPreTest {
   ...
   * vistas */
    ...
    public void testGetNeighborhoodShipOutOfBounds() {
         ...
         assertTrue(board.addShip(galeon, new Coordinate(7,6)));
         vacio.add(new Coordinate(9,6));
         vacio.add(new Coordinate(8,7));
         vacio.add(new Coordinate(8,8));
         vacio.add(new Coordinate(8,9));
         vacio.add(new Coordinate(8,6));
         assertEquals(vacio, board.getNeighborhood(galeon));
